...
class COLORS {
  static const Color primary = Color(0xff366591);
  static const Color secordary = Color(0xffF3FAFD);
  static const Color skyBlue = Color(0xff89CFF0);
  static const Color skyBlueLight = Color(0xffDBF0F9);
  static const Color skyBlueLightest = Color(0xffF3FAFD);
